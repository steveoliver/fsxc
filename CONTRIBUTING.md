...
```bash
# Clone it
$ git clone git@github.com:condurremedia/fsxc.git

# Change directory
$ cd fsxc

# Add the upstream repo
$ git remote add upstream git://github.com/condurremedia/fsxc.git
...
Copyright 2018, Condurre Media under [the Apache 2.0 license](LICENSE.txt).
